...
# ----- Wikipedia API Initialization ( and y) -----
import wikipediaapi
wiki_wiki = wikipediaapi.Wikipedia('en')

# ----- OpenWeatherMap API Initialization -----
from pyowm import OWM
owm = OWM('YOUR_OWM_API_KEY')

# ----- ipstack Geolocation API Initialization -----
...
# ---------- Interactive Story ( and y) ----------
"NOTE:  wrote and defined the options for the story, whereas y wrote definitions to validate user input for the story."

# ----- Definitions for Interactive Story ( and y) -----
...
print(
    "Hello, my name is Python Chatbot!\nI was created by Shaaz Sikanderali"
)
time.sleep(1)
returnname()
instructions()
